    ...
    <>
        ...
        <div className='flex items-center justify-around min-h-screen'>
            ...
            <div className='flex flex-col mt-20'>
                <h2 className='lg:text-8xl font-lora text-text-color'>Welcome to</h2>
                <h2 className='lg:text-8xl font-lora text-main-color'>Ovenly Hazel</h2>
            ...
            <div className='mt-20'>
                <FontAwesomeIcon icon={faCookie} className='lg:text-[250px]  text-main-color mr-20'/>
            </div>
